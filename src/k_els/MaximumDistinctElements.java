...
class MaximumDistinctElements {
    ...
    /**
     * Time complexity
     * Since we will insert all numbers in a HashMap and a Min Heap,
     * this will take O(N∗logN) where ‘N’ is the total input numbers.
     * While extracting numbers from the heap, in the worst case,
     * we will need to take out ‘K’ numbers.
