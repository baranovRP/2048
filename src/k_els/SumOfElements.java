...
class SumOfElements {
    ...
    /**
     * Time complexity
     * Since we need to put all the numbers in a min-heap,
     * the time complexity of the above algorithm will be O(N∗logN) where ‘N’ is the total input numbers.
     * <p>
     * Space complexity
     ...
     */
    public static int findSumOfElementsAlternative(int[] nums, int k1, int k2) {
