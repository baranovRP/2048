...
class NextInterval {
    ...
    public static void main(String[] args) {
        Interval[] intervals = new Interval[]{new Interval(3, 4), new Interval(5, 6), new Interval(1, 2)};
        ...
        intervals = new Interval[]{new Interval(3, 4), new Interval(5, 6), new Interval(1, 5)};
        result = NextInterval.findNextInterval(intervals);
        System.out.print("Next interval indices are: ");
        for (int index : result)
            System.out.print(index + " ");

        intervals = new Interval[]{new Interval(3, 4), new Interval(1, 5), new Interval(2, 3), new Interval(4, 6), new Interval(5, 7)};
        result = NextInterval.findNextInterval(intervals);
        System.out.print("Next interval indices are: ");
        for (int index : result)
            System.out.print(index + " ");
